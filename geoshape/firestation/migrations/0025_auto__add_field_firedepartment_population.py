...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'FireDepartment.population'
        db.add_column(u'firestation_firedepartment', 'population',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        for fd in FireDepartment.objects.all():
            if hasattr(fd, 'set_population_from_government_unit'):
                fd.set_population_from_government_unit()

    def backwards(self, orm):
        # Deleting field 'FireDepartment.population'
        db.delete_column(u'firestation_firedepartment', 'population')
